...
dataset = 'ucf101'
scene_selection = 'iou-s-dilation-std'
...
train_pipeline = [
    dict(type='ActorCutMix_v2', mix_video_dir=mix_video_dir, class_index=class_index, mix_prob=mix_prob, mask_dir_name=mask_dir_name, max_mask_ratio=max_mask_ratio),
