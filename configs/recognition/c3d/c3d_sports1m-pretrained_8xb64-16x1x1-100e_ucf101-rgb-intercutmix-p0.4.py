...
video_root = 'data/ucf101/REPP/intercutmix/mix/all-mpnet-base-v2/0.5'
video_list = 'data/ucf101/REPP/intercutmix.json'
...
train_pipeline = [
    dict(type='ActorCutMix', root=video_root, file_list=video_list, prob=0.4),
