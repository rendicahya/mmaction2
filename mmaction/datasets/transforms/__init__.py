...
from .cutmix import ActorCutMix, ActorCutMix_v2, InterCutMix, InterCutMixIncrProb
...
__all__ = [
    ...
    'CLIPTokenize', 'ActorCutMix', 'ActorCutMix_v2', 'InterCutMix', 'InterCutMixIncrProb', 'Mix2Train', 
]
